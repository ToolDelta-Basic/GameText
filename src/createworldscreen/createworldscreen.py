createWorldScreen:dict = {
    ...
    "createWorldScreen.deleteWarningFormat": "您确定要删除 '{}' 吗？这个世界将永远失去！（很长时间！）",
    "createWorldScreen.editTitleFormat": "编辑 '{}'",
    ...
    "createWorldScreen.serverSimDistanceFormat": "{} 个区块",
    ...
    "createWorldScreen.editor.deleteWarningFormat": "是否确实要删除 '{}'？这个项目将永远失去！",
