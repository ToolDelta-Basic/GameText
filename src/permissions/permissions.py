permissions: dict = {
    ...
    "permissions.MultiplayerSessions":由于您 Microsoft 账户的设置问题，您无法在 Realms 上进行游戏。请确保您的在线安全设置已允许多人游戏和俱乐部。请前往 aka.ms/MCMultiplayerHelp 查看如何更改这些设置。",
    ...
    "permissions.MultiplayerSessionsOnConsole":由于您 Microsoft 账户的设置问题，您无法在 Realms 上进行游戏。请确保您的在线安全设置已允许多人游戏和俱乐部，且当前您已拥有 Xbox Live 金会员订阅。请前往 aka.ms/MCMultiplayerHelp 查看如何更改这些设置。	disable_3rd_party_console_resource_pack_check",
