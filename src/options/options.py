options: dict = {
    ...
    "options.dev_gatherings_add_gathering":"添加公开收集",
    ...
    "options.notificationDuration.Toast":"通知提示持续时间",
    ...
    "options.useRemoteConnect":"使用 Microsoft 帐户远程连接登录（需要重新启动）",
