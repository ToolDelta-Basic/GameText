createWorldScreen: dict = {
    ...
    "createWorldScreen.experimentalSneakingFeature":"爬行",
    "createWorldScreen.experimentalSneakingFeatureDescription":"允许玩家在 1 个方块间隙下爬行",
    ...
    "createWorldScreen.experimentalCameras":"实验相机",
    "createWorldScreen.experimentalCamerasDescription":"启用相机命令",
    ...
    "createWorldScreen.gameMode.adventure":"冒险模式",
    "createWorldScreen.gameMode.creative":"创造模式",
    "createWorldScreen.gameMode.creative.desc":"无限资源。无损伤。飞行。即使您稍后切换到生存模式也无法获得成就。",
    "createWorldScreen.gameMode.survival":"生存模式",
    "createWorldScreen.gameMode.survival.desc":"资源有限，你需要工具。你可能会受伤。小心怪物。",
    "createWorldScreen.gameMode.spectator":"旁观模式",
