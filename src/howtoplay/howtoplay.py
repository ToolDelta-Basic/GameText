howtoplay: dict = {
    ...
    "howtoplay.blocks.text.7":"陶瓦 - 该方块自然存在于荒地生物群系中，或者可以使用在水下找到的黏土作为原料合成并染色制成。通过将陶瓦放入熔炉中熔化可将其制成带釉陶瓦。",
    ...
    "howtoplay.elytra.text.6":"无效的烟花火箭可用于延长鞘翅飞行。如果您使用有效的烟花火箭来延长飞行，则您会受伤。",
    ...
    "howtoplay.fireworks.text.2":"烟花有两个部分，即烟花火箭和烟花之星。",
    "howtoplay.fireworks.header.1":"烟花火箭",
    ...
    "howtoplay.fireworks.text.5":"在制作烟花火箭的过程中，可以添加烟花之星，以赋予它许多不同的颜色和效果。",
    ...
    "howtoplay.fireworks.text.6.3":"  - 苦力怕形状 - 添加头部可在空中形成苦力怕图案。",
