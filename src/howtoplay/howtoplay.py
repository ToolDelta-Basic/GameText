howtoplay: dict = {
    ...
    'howtoplay.armor.text.1=通过穿戴盔甲，您可以保护自己免受伤害。您的盔甲级别由 HUD 上的 :",
    ...
    'howtoplay.armor.text.5.keyboard=护盾可以格挡来袭的伤害。护盾可以装备在便捷槽位以及热键中。按下并长按 :",
    'howtoplay.armor.text.5.gamepad=护盾可以格挡来袭的伤害。护盾可以装备在便捷槽位以及热键中。按下:",
    'howtoplay.armor.text.5.touch=护盾可以格挡来袭的伤害。护盾可以装备在便捷槽位以及热键中。点击 :",
    'howtoplay.armor.text.5.rift_controller=护盾可以格挡来袭的伤害。护盾可以装备在便捷槽位以及热键中。按下:",
    'howtoplay.armor.text.5.windowsmr_controller=护盾可以格挡来袭的伤害。护盾可以装备在便捷槽位以及热键中。按下:",
    'howtoplay.armor.text.6=护盾甚至可以格挡一次爬行者的爆炸！",
    'howtoplay.armor.header.3=伪装",
    'howtoplay.armor.text.7=您还可以将雕刻南瓜戴在头上。这不会给予您任何 :",
    ...
    'howtoplay.armorStand.text.2.notTouch=在持拿一件盔甲的同时按下盔甲架上的 :",
    'howtoplay.armorStand.text.2.touch=在持拿一件盔甲的同时点击盔甲架即可将盔甲置于盔甲架上。",
    'howtoplay.armorStand.text.3.notTouch=在张开手时按下盔甲架上的 :",
    'howtoplay.armorStand.text.3.touch=在张开手时点击盔甲架即可从盔甲架中移除物品。",
    'howtoplay.armorStand.header.2=摆姿势",
    'howtoplay.armorStand.text.4.notTouch=盔甲架可以更改其姿势，潜行并按下盔甲架上的 :",
    ...
    'howtoplay.beds.text.2.notTouch=按床上的 :",
    ...
    'howtoplay.cauldron.text.2.notTouch=拿着一桶水或一份药水时，按炼药锅上的 :",
    ...
    'howtoplay.cauldron.text.4.notTouch=手中握有箭时，按炼药锅上的 :",
    'howtoplay.cauldron.text.4.touch=手中握有箭时，点击炼药锅即可制作各种不同用途的箭！",
    'howtoplay.cauldron.header.3=给盔甲染色",
    'howtoplay.cauldron.text.5.notTouch=若要给皮革盔甲或皮革马铠染色，请在持有所需染料时，按填满水的炼药锅上的 :",
    ...
    'howtoplay.chat.text.1.keyboard=按 :",
    'howtoplay.chat.text.1.gamepad=按 :",
    'howtoplay.chat.text.1.touch=点击“聊天”按钮以打开聊天。键入消息，然后点击“发送”按钮。",
    'howtoplay.chests=箱子",
    'howtoplay.chests.title=游戏指南：箱子",
    'howtoplay.chests.text.1.notTouch=在您制成箱子后，您可以将其置于世界中，然后使用 :",
    ...
    'howtoplay.controls.text.2.gamepad=使用 :",
    'howtoplay.controls.text.2.touch=触摸并沿屏幕拖动可环顾四周。",
    'howtoplay.controls.text.2.rift_controller=使用 :",
    'howtoplay.controls.text.2.windowsmr_controller=使用 :",
    'howtoplay.controls.text.3.keyboard=使用 :",
    'howtoplay.controls.text.3.gamepad=使用 :",
    'howtoplay.controls.text.3.touch=使用 :",
    'howtoplay.controls.text.3.rift_controller=使用 :",
    'howtoplay.controls.text.3.windowsmr_controller=使用 :",
    'howtoplay.controls.text.4.keyboard=按 :",
    'howtoplay.controls.text.4.gamepad=按 :",
    'howtoplay.controls.text.4.touch=按 :",
    'howtoplay.controls.text.4.rift_controller=按 :",
    'howtoplay.controls.text.4.windowsmr_controller=按 :",
    'howtoplay.controls.text.5.keyboard=快速连续按两次 :",
    'howtoplay.controls.text.5.gamepad=快速连续向前推两次 :",
    'howtoplay.controls.text.5.touch=快速连续按两次 :",
    'howtoplay.controls.text.5.rift_controller=快速连续向前推两次 :",
    'howtoplay.controls.text.5.windowsmr_controller=快速连续向前推两次 :",
    'howtoplay.controls.header.2=打破和放置",
    'howtoplay.controls.text.6.notTouch=按住 :",
    'howtoplay.controls.text.6.touch=触摸并按住方块所在的屏幕，可用手或者手里的东西开采和砍劈。您可能需要制作一件工具来开采一些方块。",
    'howtoplay.controls.text.7.keyboard=如果您手里正握着一件物品，使用 :",
    'howtoplay.controls.text.7.gamepad=如果您手里正握着一件物品，使用 :",
    'howtoplay.controls.text.7.rift_controller=如果您手里正握着一件物品，使用 :",
    'howtoplay.controls.text.7.windowsmr_controller=如果您手里正握着一件物品，使用 :",
    'howtoplay.controls.text.7.touch=如果您手里正握着一件物品，触摸屏幕来使用该物品，或者触摸并按住热键中的物品来丢弃它。",
    'howtoplay.controls.header.3=潜行",
    'howtoplay.controls.text.8.keyboard=潜行在《我的世界》中极为有用，可防止您从方块上跌落下来并隐藏您的姓名标签。若要潜行，请按住 :",
    'howtoplay.controls.text.8.gamepad=潜行在《我的世界》中极为有用，可防止您从方块上跌落下来并隐藏您的姓名标签。要切换潜行，请按 :",
    'howtoplay.controls.text.8.touch=潜行在《我的世界》中极为有用，可防止您从方块上跌落下来并隐藏您的姓名标签。若要切换潜行，请点击 :",
    'howtoplay.controls.text.8.rift_controller=潜行在《我的世界》中极为有用，可防止您从方块上跌落下来并隐藏您的姓名标签。若要切换潜行，请按 :",
    'howtoplay.controls.text.8.windowsmr_controller=潜行在《我的世界》中极为有用，可防止您从方块上跌落下来并隐藏您的姓名标签。若要切换潜行，请按 :",
    'howtoplay.controls.text.swim.keyboard=在水中奔跑会使您游泳。使用鼠标来控制您游泳的方向。",
    'howtoplay.controls.text.swim.gamepad=在水中奔跑会使您游泳。使用 :",
    'howtoplay.controls.text.swim.touch=在水中奔跑会使您游泳。触摸屏幕并沿着屏幕拖动来控制您游泳的方向。",
    'howtoplay.controls.text.swim.rift_controller=在水中奔跑会使您游泳。使用 :",
    'howtoplay.controls.text.swim.windowsmr_controller=在水中奔跑会使您游泳。使用 :",
    'howtoplay.worldBuilder=世界建造者",
    'howtoplay.worldBuilder.title=游戏指南：世界建造者",
    'howtoplay.worldBuilder.text.1=若要放置或使用特定的 Minecraft:",
    ...
    'howtoplay.permissionBlocks.text.1=Minecraft:",
    ...
    'howtoplay.chalkboard.text.1=黑板可以用来显示世界中的文本。相较于告示牌，黑板能够显示的文本更多，并且可以在不被摧毁的情况下进行编辑。锁定切换可让您阻止非世界建造者摧毁或编辑您的黑板。在现有的黑板上按 :",
    ...
    'howtoplay.chemistry.text.2=从 Minecraft:",
    'howtoplay.npc=非玩家角色",
    ...
    'howtoplay.camera.text.2=用您的视角拍照片，按 :",
    'howtoplay.camera.text.2.touch=如果要用您的视角拍照片，请点击并按住，然后释放。",
    'howtoplay.camera.text.3=自拍时放置摄像机，然后按上边的 :",
    ...
    'howtoplay.portfolio.text.1=您拍摄的照片会出现在相片簿中。按 :",
    ...
    'howtoplay.classroomMode.text.1=教室模式是外置应用，可为教育工作者提供与用户互动的功能。您可以从 Minecraft:",
    'howtoplay.classroomMode.text.2=作为一个世界的主人，您可以使用命令 /classroommode，启动教室模式应用，将其连接到 Minecraft:",
    ...
    'howtoplay.codeBuilder.text.2=通过按 :",
    'howtoplay.codeBuilder.text.2.touch=通过轻按 :",
    'howtoplay.crafting=合成",
    'howtoplay.crafting.title=游戏指南：合成",
    'howtoplay.crafting.text.1.keyboard=按 :",
    'howtoplay.crafting.text.1.gamepad=按 :",
    'howtoplay.crafting.text.1.touch=点击物品栏按钮可访问配方书和网格合成表。",
    'howtoplay.crafting.text.1.rift_controller=按 :",
    'howtoplay.crafting.text.1.windowsmr_controller=按 :",
    ...
    'howtoplay.crafting.text.6.keyboard=在世界中的工作台上按 :",
    'howtoplay.crafting.text.6.gamepad=在世界中的工作台上按 :",
    'howtoplay.crafting.text.6.rift_controller=在世界中的工作台上按 :",
    'howtoplay.crafting.text.6.windowsmr_controller=在世界中的工作台上按 :",
    ...
    'howtoplay.creativeMode.text.4.keyboard=若要在创造模式下飞行，请快速按两次 :",
    'howtoplay.creativeMode.text.4.gamepad=若要在创造模式下飞行，请快速按两次 :",
    'howtoplay.creativeMode.text.4.touch=若要在创造模式下飞行，请快速点击两次 :",
    ...
    'howtoplay.dispensers.text.2.notTouch=若要用物品填充发射器，请按发射器上的 :",
    ...
    'howtoplay.droppers.text.1.notTouch=当由红石提供能量时，投掷器会随机投掷其中包含的一个物品。按投掷器上的 :",
    ...
    'howtoplay.elytra.text.3.notTouch=装备鞘翅时，玩家可以在坠落时按 :",
    'howtoplay.elytra.text.3.touch=装备鞘翅时，玩家可以在坠落时点击 :",
    ...
    'howtoplay.fireworks.text.3.notTouch=若要使用焰火，只需按方块上的 :",
    ...
    'howtoplay.fishing.text.2.notTouch=瞄准水中的一个方块，在持有钓鱼竿的同时按下 :",
    ...
    'howtoplay.fishing.text.4.notTouch=当泡泡碰到饵钩时，饵钩会上下摆动。按下 :",
    ...
    'howtoplay.furnace.text.2.notTouch=将熔炉置于世界中，按下 :",
    ...
    'howtoplay.HUD.text.2=如果您失去一些生命值，但有至少九个 :",
    'howtoplay.HUD.text.3.keyboard=拿着一份食物时，按住 :",
    'howtoplay.HUD.text.3.gamepad=拿着一份食物时，按住 :",
    'howtoplay.HUD.text.3.rift_controller=拿着一份食物时，按住 :",
    'howtoplay.HUD.text.3.windowsmr_controller=拿着一份食物时，按住 :",
    'howtoplay.HUD.text.3.touch=按住一份食物即可进食。",
    'howtoplay.HUD.text.4=您必须在冒险时查看您的饥饿程度，饥饿程度在 HUD 上用 :",
    ...
    'howtoplay.HUD.text.7.gamepad=热键显示可供使用的物品。使用 :",
    'howtoplay.HUD.text.7.touch=热键显示可供使用的物品。点击热键中的物品即可更改您手中的物品。",
    'howtoplay.HUD.text.7.windowsmr_controller=热键显示可供使用的物品。按 :",
    'howtoplay.HUD.text.7.rift_controller=热键显示可供使用的物品。按 :",
    'howtoplay.inventory=物品栏",
    'howtoplay.inventory.title=游戏指南：物品栏",
    'howtoplay.inventory.text.1.keyboard=按 :",
    'howtoplay.inventory.text.1.gamepad=按 :",
    'howtoplay.inventory.text.1.rift_controller=按 :",
    'howtoplay.inventory.text.1.windowsmr_controller=按 :",
    'howtoplay.inventory.text.1.touch=点击物品栏选项卡来查看物品栏。",
    'howtoplay.inventory.text.2=此屏幕显示了您手里可用的物品和您携带的所有其他物品。盔甲也在这里显示。",
    'howtoplay.inventory.text.3.keyboard=用 :",
    'howtoplay.inventory.text.3.gamepad=使用 :",
    'howtoplay.inventory.text.3.touch=点击来选择一个物品。如果这里有一个以上物品，该动作会选择所有物品。",
    'howtoplay.inventory.text.4.keyboard=您可以用 :",
    'howtoplay.inventory.text.4.gamepad=您可以使用 :",
    'howtoplay.inventory.text.4.touch=点击物品栏的其他位置来移动物品。",
    'howtoplay.inventory.text.5.keyboard=如果光标所在物品为盔甲，可以按 SHIFT+:",
    'howtoplay.inventory.text.5.gamepad=如果光标所在物品为盔甲，可以按 :",
    'howtoplay.inventory.text.6.keyboard=若要投掷物品，请选取物品并将其放置在物品栏窗口外部。",
    'howtoplay.inventory.text.6.gamepad=若要投掷物品，请选取物品并按 :",
    ...
    'howtoplay.jukebox.text.2.notTouch=手里拿着音乐唱片的同时按唱片机上的 :",
    ...
    'howtoplay.mounts.text.3.notTouch=马、驴和骡子在利用之前必须先驯服。要驯服一匹马，需要先骑上去，在它想把您摔下来的时候保持不掉下来。按 :",
    ...
    'howtoplay.mounts.text.15.notTouch=按 :",
    'howtoplay.mounts.text.15.touch=点击 :",
    ...
    'howtoplay.pets.text.1.notTouch=在《我的世界》中，有多种可以驯服的生物，而且可以让它们成为您的宠物。可以通过给予各生物喜爱的物品来驯服它们。驯服后，您可以在看到它们时按 :",
    ...
    'howtoplay.scaffolding.text.1.keyboard=脚手架可以帮助您安全地建造巨大的建筑！您可以在脚手架内部行走，也可以站在上面。如果您拥有一列脚手架，您可以通过站在脚手架内并按 :",
    'howtoplay.scaffolding.text.1.gamepad=脚手架可以帮助您安全地建造巨大的建筑！您可以在脚手架内部行走，也可以站在上面。如果您拥有一列脚手架，您可以通过站在脚手架内并按 :",
    'howtoplay.scaffolding.text.1.touch=脚手架可以帮助您安全地建造巨大的建筑！您可以在脚手架内部行走，也可以站在上面。如果您拥有一列脚手架，您可以通过站在脚手架内并按 :",
    'howtoplay.scaffolding.text.1.rift_controller=脚手架可以帮助您安全地建造巨大的建筑！您可以在脚手架内部行走，也可以站在上面。如果您拥有一列脚手架，您可以通过站在脚手架内并按 :",
    'howtoplay.scaffolding.text.1.windowsmr_controller=脚手架可以帮助您安全地建造巨大的建筑！您可以在脚手架内部行走，也可以站在上面。如果您拥有一列脚手架，您可以通过站在脚手架内并按 :",
    ...
    'howtoplay.structureBlocks.text.9.keyboard=按 :",
    'howtoplay.structureBlocks.text.9.gamepad=使用 :",
    ...
    'howtoplay.tools.text.5.notTouch=锹非常适合用来破坏疏松的方块，例如泥土、沙子和砂砾。锹还可用于创建草径，只要在草方块上按 :",
    'howtoplay.tools.text.5.touch=锹非常适合用来破坏疏松的方块，例如泥土、沙子和砂砾。锹还可用于创建草径，只要在草方块上进行点击即可。",
    'howtoplay.tools.text.6.notTouch=需要使用锄头来耕作泥土从而种植农作物。在泥土或草方块上按 :",
    ...
    'howtoplay.transportation.text.3.keyboard=在看着矿车时按 :",
    'howtoplay.transportation.text.3.gamepad=在看到矿车时按 :",
    'howtoplay.transportation.text.3.touch=在接近矿车时点击“骑乘”按钮跃上并乘坐。按 :",
    'howtoplay.transportation.header.2=船",
    'howtoplay.transportation.text.4=船让您可以在水面上旅行，将一艘船放在水方块上，即可出发。",
    'howtoplay.transportation.text.5.keyboard=在看到船时按 :",
    'howtoplay.transportation.text.5.gamepad=在看到船时按 :",
    'howtoplay.transportation.text.5.touch=在接近船时点击“上船”按钮来上船。按 :",
    ...
    'howtoplay.weapons.text.2.notTouch=在手持剑时按 :",
    'howtoplay.weapons.text.2.touch=点击生物对其进行攻击。",
    'howtoplay.weapons.header.2=弓",
    'howtoplay.weapons.text.3.notTouch=弓是《我的世界》中的主要远程武器。按住 :",
    ...
    'howtoplay.weapons.text.5.notTouch=弩是一种可选的远程武器。按下并长按 :",
    ...
    'howtoplay.weapons.text.6.notTouch=三叉戟是近战和远程两用武器。按 :",
