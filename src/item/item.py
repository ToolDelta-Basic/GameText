item: dict = {
    "item.air.name": "空气",
    "item.apple.name": "苹果",
    "item.axolotlAdultBodySingle.name": "成年 {} 美西螈",
    "item.axolotlBabyBodySingle.name": "幼年 {} 美西螈",
    ...
    "item.tropicalBodyKobSingle.name": "{} 石首鱼",
    "item.tropicalBodySunstreakSingle.name": "{} 日纹鱼",
    "item.tropicalBodySnooperSingle.name": "{} 刺探者",
    "item.tropicalBodyDasherSingle.name": "{} 速跃者",
    "item.tropicalBodyBrinelySingle.name": "{} 咸水鱼",
    "item.tropicalBodySpottySingle.name": "{} 斑点鱼",
    "item.tropicalBodyFlopperSingle.name": "{} 飞翼鱼",
    "item.tropicalBodyStripeySingle.name": "{} 条纹鱼",
    "item.tropicalBodyGlitterSingle.name": "{} 闪鳞鱼",
    "item.tropicalBodyBlockfishSingle.name": "{} 方块鱼",
    "item.tropicalBodyBettySingle.name": "{} 贝蒂鱼",
    "item.tropicalBodyClayfishSingle.name": "{} 粘土鱼",
    "item.tropicalBodyKobMulti.name": "{}-{} 石首鱼",
    "item.tropicalBodySunstreakMulti.name": "{}-{} 日纹鱼",
    "item.tropicalBodySnooperMulti.name": "{}-{} 刺探者",
    "item.tropicalBodyDasherMulti.name": "{}-{} 速跃者",
    "item.tropicalBodyBrinelyMulti.name": "{}-{} 咸水鱼",
    "item.tropicalBodySpottyMulti.name": "{}-{} 斑点鱼",
    "item.tropicalBodyFlopperMulti.name": "{}-{} 飞翼鱼",
    "item.tropicalBodyStripeyMulti.name": "{}-{} 条纹鱼",
    "item.tropicalBodyGlitterMulti.name": "{}-{} 闪鳞鱼",
    "item.tropicalBodyBlockfishMulti.name": "{}-{} 方块鱼",
    "item.tropicalBodyBettyMulti.name": "{}-{} 贝蒂鱼",
    "item.tropicalBodyClayfishMulti.name": "{}-{} 粘土鱼",
