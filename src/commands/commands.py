commands: dict = {
    ...
    "commands.execute.falseCondition":"执行子命令 %1$s %2$s 测试失败。",
    ...
    "commands.message.warn":"§4您已收到警告。你的行为可能会被其他玩家认为是冒犯。请注意与您一起游戏的其他玩家。",
    "commands.message.toastWarn":"《我的世界》适合所有人！请务必按照我们的社区标准行事。",
    "commands.warn.invalidWarningLevel":"警告级别无效。",
    "commands.warn.playerDoesNotExist":"无法找到玩家。请选择一名有效的玩家。",
    ...
    "commands.warn.description":"向玩家发送警告消息。",
