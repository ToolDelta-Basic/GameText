hudScreen: dict = {
    ...
    "hudScreen.controlCustomization.welcome":"欢迎使用控件自定义",
    "hudScreen.controlCustomization.instructions":"拖动元素以重新定位",
    "hudScreen.controlCustomization.modify":"修改设置",
    "hudScreen.controlCustomization.continue":"出发吧！",
