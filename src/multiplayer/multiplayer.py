multiplayer:dict = {
    ...
    "multiplayer.player.joined.renamed": "{} (之前被称为 {})加入了游戏",
    "multiplayer.player.joined.realms": "{} 加入了 Realm",
    "multiplayer.player.joined.realms.renamed": "{} (之前被称为 {}) 加入了 Realm",
    "multiplayer.player.left": "{} 退出了游戏",
    "multiplayer.player.left.realms": "{} 退出了 Realm",
    "multiplayer.player.changeToPersona": "{}编辑了角色外观。",
    "multiplayer.player.changeToSkin": "{} 已更改他们的皮肤。",
    "multiplayer.stopSleeping": "起床",
    "multiplayer.playersSleeping": "{}/{} 名玩家已入睡",
