authentication: dict = {
    ...
    "authentication.unauthenticated":该帐户无法使用 Minecraft:",
    ...
    "authentication.trialWelcome":欢迎！%1%1在您的学校或组织需要购买许可证之前，您有 %2 次 Minecraft:",
    "authentication.trialWarning":在您的学校或组织需要购买许可证之前，您有 %2 次 Minecraft:",
    "authentication.trialEnded":您的 Minecraft:",
    ...
    "authentication.store.intro":您的 Minecraft:",
    ...
    "authentication.store.purchase.info2":购买之后您可以访问 iTunes 账户，管理您的订阅，关闭自动更新。如果您在订阅激活后取消，订阅剩余有效期间将不予退款。此订阅会让您的 iTunes 账户将与您的 Office 365 教育版账户关联，因此您将失去资格，无法使用此 iTunes 账户购买额外的 Minecraft:",
    ...
    "authentication.error.outOfDate.body":很抱歉， 此版本的 Minecraft:",
    "authentication.error.outOfDate.downloadPage":转至下载页面",
    "authentication.error.accountType.body":哎呀！看来您使用了个人账户进行登录。此账户不符合使用 Minecraft:",
